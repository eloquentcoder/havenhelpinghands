...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`programs_gallery\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`programs_gallery_order_idx\` ON \`programs_gallery\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`programs_gallery_parent_id_idx\` ON \`programs_gallery\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`programs_gallery_image_idx\` ON \`programs_gallery\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`programs_impact_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`value\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`programs_impact_stats_order_idx\` ON \`programs_impact_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`programs_impact_stats_parent_id_idx\` ON \`programs_impact_stats\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`programs_hero_image_idx\` ON \`programs\` (\`hero_image_id\`);`)
  await db.run(sql`CREATE INDEX \`programs_seo_seo_og_image_idx\` ON \`programs\` (\`seo_og_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_programs_v_version_gallery\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_programs_v\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_programs_v_version_gallery_order_idx\` ON \`_programs_v_version_gallery\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_programs_v_version_gallery_parent_id_idx\` ON \`_programs_v_version_gallery\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_programs_v_version_gallery_image_idx\` ON \`_programs_v_version_gallery\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_programs_v_version_impact_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`value\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_programs_v_version_impact_stats_order_idx\` ON \`_programs_v_version_impact_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_programs_v_version_impact_stats_parent_id_idx\` ON \`_programs_v_version_impact_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_programs_v\` (
  	...
  	\`version_status\` text DEFAULT 'ongoing',
  ...
  await db.run(sql`CREATE INDEX \`_programs_v_version_version_hero_image_idx\` ON \`_programs_v\` (\`version_hero_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_programs_v_version_seo_version_seo_og_image_idx\` ON \`_programs_v\` (\`version_seo_og_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`team\` (
  	...
  	\`name\` text NOT NULL,
  	\`role\` text NOT NULL,
  	\`group\` text DEFAULT 'staff' NOT NULL,
  	\`photo_id\` integer,
  	\`bio\` text,
  ...
  await db.run(sql`CREATE TABLE \`posts\` (
  	...
  	FOREIGN KEY (\`author_id\`) REFERENCES \`team\`(\`id\`) ON UPDATE no action ON DELETE set null,
  ...
  await db.run(sql`CREATE INDEX \`posts_rels_programs_id_idx\` ON \`posts_rels\` (\`programs_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_posts_v\` (
  	...
  	FOREIGN KEY (\`version_author_id\`) REFERENCES \`team\`(\`id\`) ON UPDATE no action ON DELETE set null,
  ...
  await db.run(sql`CREATE INDEX \`_posts_v_rels_programs_id_idx\` ON \`_posts_v_rels\` (\`programs_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`events_seo_seo_og_image_idx\` ON \`events\` (\`seo_og_image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_events_v_version_seo_version_seo_og_image_idx\` ON \`_events_v\` (\`version_seo_og_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`site_settings\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`organisation_name\` text DEFAULT 'Haven Healing Hands Initiative' NOT NULL,
  	\`tagline\` text,
  	\`description\` text,
  	\`logo_id\` integer,
  ...
  `)
  await db.run(sql`CREATE TABLE \`homepage_impact_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`value\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`homepage_impact_stats_order_idx\` ON \`homepage_impact_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`homepage_impact_stats_parent_id_idx\` ON \`homepage_impact_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`homepage\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`headline\` text NOT NULL,
  	\`subtext\` text,
  	\`hero_image_id\` integer,
  	\`primary_cta_label\` text DEFAULT 'Donate',
  	\`primary_cta_url\` text DEFAULT '/donate',
  	\`secondary_cta_label\` text DEFAULT 'Our programs',
  	\`secondary_cta_url\` text DEFAULT '/programs',
  ...
  await db.run(sql`CREATE INDEX \`homepage_seo_seo_og_image_idx\` ON \`homepage\` (\`seo_og_image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`homepage_rels_programs_id_idx\` ON \`homepage_rels\` (\`programs_id\`);`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`programs_gallery\`;`)
  await db.run(sql`DROP TABLE \`programs_impact_stats\`;`)
  await db.run(sql`DROP TABLE \`programs\`;`)
  await db.run(sql`DROP TABLE \`_programs_v_version_gallery\`;`)
  await db.run(sql`DROP TABLE \`_programs_v_version_impact_stats\`;`)
  ...
  await db.run(sql`DROP TABLE \`homepage_impact_stats\`;`)
